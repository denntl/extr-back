...
readonly class CommentService
{
    ...
    public function clone(int $commentId, int $appPublicId): ApplicationComment
    {
        /** @var ApplicationService $applicationService */
        $applicationService = app(ApplicationService::class);
        $application = $applicationService->getByPublicId($appPublicId, false);
    ...
    public function create(int $appPublicId, array $data): ApplicationComment
    {
        /** @var ApplicationService $applicationService */
        $applicationService = app(ApplicationService::class);
        $application = $applicationService->getByPublicId($appPublicId, false);
