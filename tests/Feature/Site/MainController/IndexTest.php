...
class IndexTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->withoutMiddleware(RedirectToAdminPanel::class);
    }
    ...
    public function testClickWasAdded()
    {
        ...
        $application = Application::factory()->create([
            ...
            'link' => 'https://test.com?external_id={external_id}&sub1={sub_id_1}&sub4={sub_id_4}&sub8={sub_id_8}'
        ]);
        ...
        $externalId = $response->viewData('externalId');

        $this->assertEquals(1, $application->pwaClients()->count());

        $pwaClient = $application->pwaClients()->first();

        $this->assertDatabaseHas('pwa_client_clicks', [
            ...
            'pixel_id' => 'test_pixel_id',
            'pixel_key' => 'test_pixel_key',
            'link' => "https://test.com?external_id=$externalId&sub1=test1&sub4=test4&sub8=test8"
        ]);

        $request->cookies->set("application_{$application->id}_client_id", $pwaClient->external_id);
