...
class CreateInvoiceWithExpiredPaymentTest extends TestCase
{
    use WithFaker;
    ...
    public function testSuccess()
    {
        ...
        $this->assertEquals(Status::Canceled->value, $currentPayment->status);

        $balanceTransaction = BalanceTransaction::query()->where('id', $currentPayment->balance_transaction_id)->firstOrFail();
        $this->assertEquals(Status::Canceled->value, $balanceTransaction->status);
