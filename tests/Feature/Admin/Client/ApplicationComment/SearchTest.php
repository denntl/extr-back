...
class SearchTest extends TestCase
{
    public function testSearchQueryIsNotProvided()
    {
        ...
        $response = $this->getRequest(route('client.application.comment.search'), $token);
    ...
    public function testSuccess()
    {
        ...
        $response = $this->getRequest(route('client.application.comment.search', ['query' => 'descript']), $token);
