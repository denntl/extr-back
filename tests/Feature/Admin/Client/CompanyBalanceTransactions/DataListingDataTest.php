...
class DataListingDataTest extends TestCase
{
    ...
    public function testSuccess()
    {
        ...
        $response = $this->postRequest(
            route('client.listing.data', ['entity' => EntityName::ClientMyCompanyBalanceTransactions->value]),
            [],
            $token
        );
    ...
    {
        [$token, $user]  = $this->getUserToken(PermissionName::ClientCompanyBalanceTransactionsRead);
        /** @var BalanceTransaction $balanceTransaction */
        $balanceTransaction = BalanceTransaction::factory()->create([
    ...
    public function testSuccessFilter()
    {
        ...
        $response = $this->postRequest(
            route('common.listing.data', ['entity' => EntityName::ClientMyCompanyBalanceTransactions->value]),
            [
                'filters' => [
